function Set-GraphDeviceConfiguration() {
    <#
        .SYNOPSIS
            Update Intune Device Configurations through Microsoft Graph
        .DESCRIPTION
            https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-windows10generalconfiguration-update?view=graph-rest-beta
        .PARAMETER Id
            Id of the Device Configuration Profile to update
