function Get-GraphGroupPolicyConfigurationAssignment() {
    <#
        .SYNOPSIS
            Get Intune Group Policy Configuration Assignments through Microsoft Graph
        .DESCRIPTION
            https://docs.microsoft.com/en-us/graph/api/intune-grouppolicy-grouppolicyconfigurationassignment-list?view=graph-rest-beta
        .PARAMETER Id
            The Id of the Group Policy Configuration.
    ...
    process {
        try {
            ...
            $uri = "https://graph.microsoft.com/$apiVersion/deviceManagement/groupPolicyConfigurations/$id/assignments"
