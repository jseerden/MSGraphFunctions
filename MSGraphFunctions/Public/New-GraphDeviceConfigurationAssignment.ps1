function New-GraphDeviceConfigurationAssignment() {
    <#
        .SYNOPSIS
            New Intune Device Configuration Assignment through Microsoft Graph
        .DESCRIPTION
            https://docs.microsoft.com/en-us/graph/api/intune-deviceconfig-deviceconfiguration-assign?view=graph-rest-beta
        .PARAMETER Id
    ...
    process {
        try {
            ...
            $uri = "https://graph.microsoft.com/$apiVersion/deviceManagement/deviceConfigurations/$id/assign"
            $uri
