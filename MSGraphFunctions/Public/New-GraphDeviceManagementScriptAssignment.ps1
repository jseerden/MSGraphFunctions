function New-GraphDeviceManagementScriptAssignment() {
    <#
        .SYNOPSIS
            New Intune Device Management Script Assignment through Microsoft Graph
        .DESCRIPTION
            https://docs.microsoft.com/en-us/graph/api/intune-devices-devicemanagementscript-assign?view=graph-rest-beta
        .PARAMETER Id
    ...
    process {
        try {
            ...
            $uri = "https://graph.microsoft.com/$apiVersion/deviceManagement/deviceManagementScripts/$id/assign"
            $uri
